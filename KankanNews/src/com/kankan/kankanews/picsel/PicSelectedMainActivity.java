...
//		Log.e("allImgs", allImgs.get(10));
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		List<String> mainSeleted = (List<String>)this.getIntent().getSerializableExtra("IMAGE_SELECTED_LIST");
...
//				Log.e("allImgs", allImgs.get(10));
	...
	private void initEvent()
	{
		...
		selectedOk.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				getIntent().putExtra("NEW_IMAGE_SELECTED_LIST", (Serializable)mSelectedImage);
