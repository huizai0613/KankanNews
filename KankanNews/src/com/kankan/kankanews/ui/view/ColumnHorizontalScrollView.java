...
public class ColumnHorizontalScrollView extends HorizontalScrollView {
	...
	protected void onScrollChanged(int paramInt1, int paramInt2, int paramInt3,
		...
		shade_ShowOrHide();
		if (!activity.isDetached() && ll_content != null && leftImage != null
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		CrashApplication.getInstance().Coupontime = 0;
	 ...
	 * 传入父类布局中的资源文件
	 * */
	public void setParam(Fragment activity, int mScreenWitdh, View paramView1,
	...
	public void shade_ShowOrHide() {
		if (!activity.isDetached() && ll_content != null) {
			measure(0, 0);
