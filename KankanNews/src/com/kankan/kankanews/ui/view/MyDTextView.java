 ...
 * @下午5:29:27
 */
public class MyDTextView extends TextView {
	 /**
     * 缓存测量过的数据
     */
    ...
    public MyDTextView(Context context) {
        super(context);
        init(context);
    }

    public MyDTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MyDTextView(Context context, AttributeSet attrs, int defStyle) {
